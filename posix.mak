...
SRC_DOCUMENTABLES = index.d $(addsuffix .d,$(STD_MODULES) $(STD_NET_MODULES) \
    $(EXTRA_DOCUMENTABLES) $(STD_TERMINAL_MODULES))
...
STD_TERMINAL_MODULES = $(addprefix std/terminal/, cursor application) \
    $(addprefix std/terminal/geometry/, point rect size) \
    $(addprefix std/terminal/graphics/, color graphicscontext) \
    $(addprefix std/terminal/widgets/, responder control event terminal)
